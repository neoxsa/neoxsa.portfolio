...
function ProjectBigCard() {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div
        className="flex flex-col gap-20 px-4 sm:px-6 md:px-12 lg:px-20 w-full max-w-7xl">
            ...
            >
              ...
              <div className="w-full lg:w-1/2">
                <img
                  ...
                  alt={project.title}
                  loading='lazy'
                  className="w-full h-auto object-cover rounded-lg border-2 border-emerald-600 aspect-video md:aspect-auto md:h-72 lg:h-90"/>
              </div>
