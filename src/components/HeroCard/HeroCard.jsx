    ...
    <section className="relative w-full flex flex-col gap-10 lg:flex-row items-center justify-center px-6 lg:px-20 py-28 lg:pt-60 bg-black/50 overflow-hidden">
      ...
      <div className="relative lg:absolute lg:right-20 lg:top-10 w-4/5 sm:w-3/4 md:w-1/3 flex justify-center z-40 mb-10 md:mb-0 group ">
        <div className="relative max-w-[340px]" style={{ filter: 'drop-shadow(0 0 8px #16a34a)' }}>
          ...
          {/* Inner glowing line */}
          <div
            className="absolute inset-1.5 border border-green-400/40 pointer-events-none"
            style={{
              clipPath:
      ...
      >
        ...
        <p className="text-gray-300 text-base sm:text-lg md:text-xl mb-8 relative z-20 text-center md:text-left">
          Crafting modern, responsive web experiences with React, JavaScript,
          and next-gen technologies. Focused on precision, performance, and
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start">
          ...
          {/* <Link
            to="/projects"
            className="inline-block text-black bg-green-600 px-7 lg:px-8 py-3  font-semibold uppercase tracking-widest hover:bg-emerald-400 active:bg-emerald-400 transition-all duration-300 relative z-20"
            style={{
              clipPath:
                'polygon(30px 0,100% 0,100% calc(100% - 30px),calc(100% - 30px) 100%,0 100%,0 30px)',
            }}
